<template>
  <view class="symptom-form">
    ...
    <scroll-view scroll-y="true">
      <view class="form-content">
        <a-form
          ref="bxform"
          class="a-form"
          v-if="currentSymptom && currentSymptom.daq_survey_activity_no"
          :fields="configCols"
          label-position="top"
          option-mode="normal"
          pageType="add"
        ></a-form>
        <view
          class="symptom-date-selector"
          v-if="formType === 'symptom_record'"
        >
        ...
        <view class="remark" v-if="formType === 'symptom_record'">
    ...
    <view class="button-box">
      <button
        class="cu-btn next-btn bg-gray shadow-blur round margin-top"
        @click="submitFormData('cancel')"
      >
        取消
      </button>
      <button
        class="cu-btn next-btn bg-blue shadow-blur round margin-top"
        type="primary"
