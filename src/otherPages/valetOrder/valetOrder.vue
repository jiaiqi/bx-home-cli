      ...
      async addOrder() {
        ...
        const req = [{
          ...
          "data": [{
            ...
            "cus_type": "自建用户",
            "hotel_hy_no": this.selectedUser?.user_account,
            "person_no": this.selectedUser?.person_no,
            "person_name": this.selectedUser?.name || this.selectedUser?.nick_name,
            "store_user_no": this.selectedUser?.store_user_no,
            "order_amount": 0,
            "pay_method": "微信",
            "commission_money": 0,
