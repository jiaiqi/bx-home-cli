<template>
  <view v-if="currFood" class="food_wrap">
    <view
      class="cu-bar bg-white food_wrap_top"
      :class="pageType ? '' : 'ingredient'"
    >
      <view @click="clickTop('edit')" v-if="pageType" class="button">编辑</view>
      <view class="date-time">
        <view class="date-time-rq">{{ nowDate }}</view>
        /
        <view class="date-time-rq">{{
          currTime ? currTime : nowDateTime
        }}</view>
      </view>
      <view @click="clickTop('add')" v-if="pageType" class="button confir-btn"
        >增加食材</view
      >
    </view>
    ...
    <view class="content">
      <view class="food-list">
        <view class="list-item">
          <view @click="blowImage(currFood.imgurl)" class="img-box"
            ><image :src="currFood.imgurl"></image
          ></view>
          <view class="info">
          ...
          <view class="calorie"
            >{{ heatNum ? heatNum.toFixed(1) : "" }}千卡</view
          >
        </view>
      </view>
        ...
        <view class="ele-text-top-tit">
          <text
            ...
            v-if="
              item.name === '食材组成'
                ? currFood.meal_no ||
                  (currFood.mix_type && currFood.mix_type === '混合')
                : true
            "
            :key="index"
          ...
          <view class="ele-text-cen-item">
            ...
            <view class="ele-text-cen-item-cen">
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.protein ? Number(currFood.protein).toFixed(1) : ""
                  }}g</text
                >
                <text style="color: red"
                  >({{
                    currFood.protein >= 30.1
                      ? "高"
                      : currFood.protein >= 15.5 && currFood.protein < 30.1
                      ? "中"
                      : "低"
                  }})</text
                >
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.carbohydrate
                      ? Number(currFood.carbohydrate).toFixed(1)
                      : ""
                  }}g</text
                >
                <text style="color: red">
                  ({{
                    currFood.carbohydrate >= 51.9
                      ? "高"
                      : currFood.carbohydrate >= 25.74 &&
                        currFood.carbohydrate < 51.9
                      ? "中"
                      : "低"
                  }})
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.axunge ? Number(currFood.axunge).toFixed(1) : ""
                  }}g</text
                >
                <text style="color: red"
                  >({{
                    currFood.axunge >= 35.3
                      ? "高"
                      : currFood.axunge >= 17.6 && currFood.axunge < 35.3
                      ? "中"
                      : "低"
                  }})</text
                >
            ...
            <view class="ele-text-cen-item-cen">
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.vitamin_a
                      ? Number(currFood.vitamin_a).toFixed(1)
                      : ""
                  }}ug</text
                >
                <text style="color: red"
                  >({{
                    currFood.vitamin_a >= 915
                      ? "高"
                      : currFood.vitamin_a >= 457 && currFood.vitamin_a < 915
                      ? "中"
                      : "低"
                  }})</text
                >
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.vitamin_e
                      ? Number(currFood.vitamin_e).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red"
                  >({{
                    currFood.vitamin_e >= 27.9
                      ? "高"
                      : currFood.vitamin_e >= 13.9 && currFood.vitamin_e < 27.9
                      ? "中"
                      : "低"
                  }})</text
                >
            ...
            <view class="ele-text-cen-item-cen">
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.vitamin_b1
                      ? Number(currFood.vitamin_b1).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red">
                  ({{
                    currFood.vitamin_b1 >= 0.61
                      ? "高"
                      : currFood.vitamin_b1 >= 0.32 &&
                        currFood.vitamin_b1 < 0.61
                      ? "中"
                      : "低"
                  }})
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.vitamin_b2
                      ? Number(currFood.vitamin_b2).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red"
                  >({{
                    currFood.vitamin_b2 >= 0.79
                      ? "高"
                      : currFood.vitamin_b2 >= 0.4 && currFood.vitamin_b2 < 0.79
                      ? "中"
                      : "低"
                  }})</text
                >
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.vitamin_b3
                      ? Number(currFood.vitamin_b3).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red">
                  ({{
                    currFood.vitamin_b3 >= 4.52
                      ? "高"
                      : currFood.vitamin_b3 >= 2.26 &&
                        currFood.vitamin_b3 < 4.52
                      ? "中"
                      : "低"
                  }})
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.vitamin_c
                      ? Number(currFood.vitamin_c).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red"
                  >({{
                    currFood.vitamin_c >= 61.2
                      ? "高"
                      : currFood.vitamin_c >= 30.6 && currFood.vitamin_c < 61.2
                      ? "中"
                      : "低"
                  }})</text
                >
            ...
            <view class="ele-text-cen-item-cen">
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_ca
                      ? Number(currFood.element_ca).toFixed(1)
                      : ""
                  }}mg/</text
                >
                <text style="color: red"
                  >({{
                    currFood.element_ca >= 381
                      ? "高"
                      : currFood.element_ca >= 190.5 &&
                        currFood.element_ca < 381
                      ? "中"
                      : "低"
                  }})</text
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_mg
                      ? Number(currFood.element_mg).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red">
                  ({{
                    currFood.element_mg >= 111.6
                      ? "高"
                      : currFood.element_mg >= 55.8 &&
                        currFood.element_mg < 111.6
                      ? "中"
                      : "低"
                  }})
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_p
                      ? Number(currFood.element_p).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red">
                  ({{
                    currFood.element_p >= 296.4
                      ? "高"
                      : currFood.element_p >= 148.2 &&
                        currFood.element_p < 296.4
                      ? "中"
                      : "低"
                  }})
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_k
                      ? Number(currFood.element_k).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red">
                  ({{
                    currFood.element_k >= 526.2
                      ? "高"
                      : currFood.element_k >= 263.1 &&
                        currFood.element_k < 526.2
                      ? "中"
                      : "低"
                  }})
            ...
            <view class="ele-text-cen-item-cen">
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_fe
                      ? Number(currFood.element_fe).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red"
                  >({{
                    currFood.element_fe >= 7.2
                      ? "高"
                      : currFood.element_fe >= 3.6 && currFood.element_fe < 7.2
                      ? "中"
                      : "低"
                  }})</text
                >
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_zn
                      ? Number(currFood.element_zn).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red"
                  >({{
                    currFood.element_zn >= 6
                      ? "高"
                      : currFood.element_zn >= 3 && currFood.element_zn < 6
                      ? "中"
                      : "低"
                  }})</text
                >
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_se
                      ? Number(currFood.element_se).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red">
                  ({{
                    currFood.element_se >= 23.82
                      ? "高"
                      : currFood.element_se >= 11.91 &&
                        currFood.element_se < 23.82
                      ? "中"
                      : "低"
                  }})
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_cu
                      ? Number(currFood.element_cu).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red">
                  ({{
                    currFood.element_cu >= 1.12
                      ? "高"
                      : currFood.element_cu >= 0.56 &&
                        currFood.element_cu < 1.12
                      ? "中"
                      : "低"
                  }})
              ...
              <view class="ele-text">
                ...
                <text
                  >{{
                    currFood.element_mn
                      ? Number(currFood.element_mn).toFixed(1)
                      : ""
                  }}mg</text
                >
                <text style="color: red">
                  ({{
                    currFood.element_mn >= 4.44
                      ? "高"
                      : currFood.element_mn >= 2.22 &&
                        currFood.element_mn < 4.44
                      ? "中"
                      : "低"
                  }})
        ...
        >
          <view class="shop-detail-bot-tab">
            ...
            <view v-if="foodChild.length > 0" class="shop-detail-bot-tab-m">
              <view
                v-for="(item, index) in foodChild"
                :key="index"
                class="shop-detail-bot-tab-m-item"
              >
                <text>{{ item.name }}</text>
            ...
            <view v-else class="detail-none">
              <view class="detail-none-t">
                <image
                  src="/otherPages/static/img/noneData.png"
                  mode=""
                ></image>
                <text>暂无数据</text>
              </view>
      ...
      <view class="calculate">
        <view v-if="!currFood.meal_no" class="cook weight">
          ...
          <text
            v-if="currentCookData"
            @click.stop="clickCook"
            :class="isCookDataChoose ? 'active-cook-data' : ''"
            >{{ currentCookData }}</text
          >
        ...
        <view v-if="isShowZx" class="minced">
          ...
          <text
            v-for="(item, index) in minceListChoose"
            :key="item.id"
            class="minced-item minced-item-active"
            >{{ item.name }}</text
          >
          <!-- </view> -->
          <!-- <view @click="chooseCook('minkes')" class="minced-right-add"> -->
          <text
            @click="chooseCook('minkes')"
            class="lg text-gray cuIcon-add minced-right-add"
          ></text>
          <!-- </view>			 -->
        </view>
        <view v-if="isShowZx" class="minced">
          ...
          <!-- <view class="minced-item-all"> -->
          <text
            v-for="(item, index) in chooseBurdening"
            :key="item.id"
            class="minced-item minced-item-active"
            >{{ item.name }}</text
          >
        ...
        <view class="weight">
          ...
          <view
            @click="chooseTime(u, ids)"
            v-for="(u, ids) in dinnerTime"
            :key="ids"
            :class="currFoodTime == u.value ? 'active-unit' : ''"
            class="unit"
          >
            {{ u.value }}
          </view>
        ...
        <view class="weight">
          ...
          <view
            @click="chooseUnit(u, ids)"
            v-for="(u, ids) in unitList"
            :key="ids"
            :class="currIndex == ids ? 'active-unit' : ''"
            class="unit"
          >
          ...
          <view class="cu-list menu text-left">
            ...
            >
              <label class="flex justify-between align-center flex-sub">
                <view class="flex-sub">{{
                  item.unit_amount ? item.unit_amount + item.unit : item.unit
                }}</view>
                <radio
                  class="round"
    ...
    <view
      v-if="!currFood.meal_no"
      class="cu-modal bottom-modal"
      :class="isShowCookType ? 'show' : ''"
    >
      <view class="cu-dialog">
        ...
        <view class="padding-xl">
          <view class="cook-wrap">
            <view
              ...
              class="cook-item"
              :class="
                currentCookData == cook.value && isCookDataChoose
                  ? 'active-cook-item'
                  : ''
              "
            >
    ...
    <view
      class="cu-modal bottom-modal"
      :class="{ show: showUserHealtManagePopup }"
    >
      <view class="cu-dialog">
        <view class="health-item">
          ...
          >
            <bx-checkbox
              ...
              v-for="(item, index) in minceList"
              :key="item.id"
              :name="item.name"
              >{{ item.name }}</bx-checkbox
            >
          </bx-checkbox-group>
  ...
  methods: {
    ...
    clickTop (type) {
      if (type === 'edit') {
        ...
        uni.navigateTo({
          url: '/publicPages/form/form?type=update&fieldsCond=' + encodeURIComponent(JSON.stringify(fieldsCond))
        });
      } else if (type === 'add') {
        uni.navigateTo({
    ...
    changeApprove (item, index) {
      if (item.type === 'mine' && (!item.age || !item.sex)) {
        uni.showModal({
          title: '提示',
          content: '当前没有进行登记年龄、性别和或重，是否去登记?',
      ...
      if (this.chooseFoods.length > 0) {
        ...
        this.chooseFoods.forEach(item => {
          let obj = {
            ...
            person_name: this.vuex_userInfo.name || this.vuex_userInfo.nick_name,
            amount: item.amount,
