  ...
  <view class="page-wrap">
    <view class="fixed cu-bar">
      <list-bar style="width: 100%;" :srvApp="appName" @change="changeSerchVal" :srvCols="filterCols"
        :orderColExtension="orderColExtension" :listButton="customButton" :custom-button="customButton"
        @toOrder="toOrder" :main-data="mainData" @toFilter="toFilter" @onGridButton="clickGridButton"
      ...
      async getColV2() {
        ...
        try {
          if (colVs.moreConfig?.tableConfig?.filterColExtension) {
            colVs.moreConfig.tableConfig.filterColExtension = await this.handleExtensionCol(colVs.moreConfig
          ...
          if (colVs.moreConfig?.tableConfig?.searchColExtension) {
            colVs.moreConfig.tableConfig.searchColExtension = await this.handleExtensionCol(colVs.moreConfig
