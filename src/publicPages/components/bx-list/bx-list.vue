<template>
  <view class="list-wrap">
    <view class="list-wrap">
      ...
      >
        <view class="flex text-center">
          ...
          >
            ...
            <text
              class="text-red"
              style="margin-left: 10upx; padding: 0 10upx; border-radius: 10upx"
              >{{ item.total }}</text
            >
          </view>
        </view>
      ...
      >
        <view
          :class="{ 'grid-layout': onlyShowTitle }"
          v-if="listType === 'list'"
        >
          <list-item
            ...
            :key="item[rowKey]"
            :itemData="item"
            :labels="ShowLabelColumn"
            :viewTemp="finalViewTemp"
            :viewType="viewType"
            :imageNum="imageNum"
