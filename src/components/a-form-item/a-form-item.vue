<template>
  ...
  >
    ...
    >
      ...
      <view
        class="form-item-content_detail rich-text"
        v-else-if="
          pageType === 'detail' &&
          (field.type === 'snote' ||
            field.type === 'Note' ||
      ...
      <bx-radio-group
        ...
        :mode="optionMode"
        v-model="fieldData.value"
        v-else-if="fieldData.type === 'radioFk'"
        @change="radioChange"
      >
        <bx-radio
      ...
      <view
        ...
        v-else-if="popupFieldTypeList.includes(fieldData.type)"
      >
        ...
        >
          <bx-checkbox-group
            v-if="fieldData.type === 'Set'"
            class="form-item-content_value checkbox-group"
            v-model="fieldData.value"
            mode="button"
          >
            <bx-checkbox
              v-for="item in setOptionList"
              :name="item.value"
              :key="item.value"
              v-model="item.checked"
            >
        ...
        <view @click="openModal(fieldData.type)" class="open-popup" v-else>
          ...
          <view
            class="value hidden"
            v-else-if="fieldData.value && isArray(fieldData.value)"
          >
      ...
      <view
        class="form-item-content_value picker"
        v-else-if="pickerFieldList.includes(fieldData.type)"
      >
        <picker
          class="uni-picker"
          :mode="pickerMode"
      ...
      <view
        class="form-item-content_value textarea"
      ...
      <view
        class="form-item-content_value location"
        v-else-if="fieldData.type === 'addr' || fieldData.type === 'location'"
        @click="getLocation"
      >
      ...
      <view
        class="form-item-content_value"
        v-else-if="fieldData.type === 'RichText'"
      ...
      />
      <view
        class="form-item-content_value slider"
        v-else-if="
          (fieldData.type === 'number' || fieldData.type === 'digit') &&
          fieldData.max
        "
    ...
    <view
      class="icon-area"
      v-if="fieldData.type === 'location' || fieldData.type === 'addr'"
      ><text class="cuIcon-locationfill text-blue" @click="getLocation"></text
    ></view>
    ...
    <view
      class="cu-modal bottom-modal"
      :class="{ show: modalName === 'TreeSelector' }"
      @tap="hideModal"
    >
      <view class="cu-dialog" @tap.stop="">
        <view
          class="tree-selector cascader"
          v-if="modalName === 'TreeSelector'"
        >
          <cascader-selector
        ...
        <view class="tree-selector">
          <view class="content">
            ...
            >
              ...
              <text
                class="cu-btn cuIcon-refresh line-blue shadow round"
                @click="getSelectorData(null, null, null)"
              ></text>
            </view>
            <bx-checkbox-group
              v-if="modalName === 'MultiSelector'"
              class="form-item-content_value checkbox-group"
              v-model="fieldData.value"
              mode="button"
            >
