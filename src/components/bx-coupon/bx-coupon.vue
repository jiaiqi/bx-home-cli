<template>
  <view class="temp-1" :style="[setStyle]" v-if="cfg&&cfg.template_name==='模板1'&&data&&data.coupon_no">
    <view class="left">
  ...
  <view class="temp-2" v-else-if="cfg&&cfg.template_name==='模板2'&&data&&data.coupon_no">
    <view class="top">
      ...
      <view class="right" v-if="data.coupon_button_txt">
        <text>
          {{data.coupon_button_txt.slice(0,2)||''}}
        </text>
        <text>
          {{data.coupon_button_txt.slice(2)||''}}
        </text>
      </view>
    </view>
    <view class="bottom">
