  ...
  <view class="filtrate-wrap">
      ...
      <view class="flexSelece">
        <view class="box">
          <view class="cu-bar search bg-white">
            ...
            <view class="action"
              ><text style="margin-right: 20rpx" @click="search"
                >搜索</text
              ></view
            >
          </view>
    ...
    <view class="filtrate-item-wrap">
      <view
        ...
        :key="index"
        class="filtrate-item"
        :class="showSearch ? '' : 'padding-filtrate-item'"
      >
        <view
          class="filtrate-item-left"
          style="display: flex; flex-shrink: 0; max-width: 152rpx"
        ...
        >
          <view class="smallbox">
            ...
            <view class="textbox">
              ...
              <view
                v-if="
                  searchArg.serviceName === 'srvhealth_person_relation_select'
                "
                class="content-right"
                @click.stop="toMessage(food)"
              >
