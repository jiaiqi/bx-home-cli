...
export function getSystem() {
  ...
  if (menuButtonInfo?.top && menuButtonInfo?.height) {
    system.menuButtonTop = menuButtonInfo?.top + menuButtonInfo?.height
  } else {
    system.menuButtonTop = 0
    if (system.statusBarHeight) {
      system.menuButtonTop = system.statusBarHeight
    }
  }
  system.h = system.windowHeight - system.menuButtonTop
  return {
    ...system,
    w: system.windowWidth,
    // h:  system.h || system.windowHeight,
    scale: scale
  }
}
