        ...
        <view class="store-user-box" v-if="bindUserInfo">
          ...
          <view class="setting-item">
            ...
            <view class="setting-content">
              <bx-checkbox-group class="form-item-content_value checkbox-group" v-model="push_msg_set" mode="button">
                <bx-checkbox v-for="(item,index) in pushMsgSetOptions" :key="index" :name="item.value"
          ...
          <view class="exit-store-user" v-if="bindUserInfo && bindUserInfo.store_user_no">
            ...
            <button class="cu-btn bg-blue margin-right"
              :disabled="push_msg_set == bindUserInfo.push_msg_set && member_status !== '退出'" @click="savePushSet">
              保存设置
            </button>
          ...
          if (isBind && isBind.person_no) {
            ...
            if (invite_user_no!==this.userInfo?.userno) {
              if (this.StoreInfo?.standard !== '不更新') {
                ...
                if (inviterStoreUser && inviterStoreUser.store_user_no && inviterStoreUser.store_user_no !== this
