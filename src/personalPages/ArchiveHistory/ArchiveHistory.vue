<template>
  <view class="history-wrap">
    ...
    <view class="history-chart" v-if="isAllPages">
      ...
      <uniEcCharts class="uni-ec-charts" id="uni-ec-canvas" v-if="currentChart === 'canvasLineA'" :ec="weightEcData">
      </uniEcCharts>
      ...
      <uniEcCharts class="uni-ec-charts" id="uni-ec-canvas" v-if="currentChart === 'canvasLineC'" :ec="sleepEcData">
      </uniEcCharts>
    </view>
    <view class="button-box" v-if="isAllPages">
      <button class="buttons" :class="{ active: currentChart === item.chartID }" size="mini" v-for="item in subList"
        :key="item.key" @click="showCanvas(item.key)">
        {{ item.name }}
      </button>
    </view>
      ...
      <view class="history-content">
        ...
        <view class="other-record" v-if="
          ...
          <view class="bmi-box" v-if="pageType === 'weight'">
            <view class="bmi-bar-box" v-if="bmi">
              <view class="last-data">
                <view class="text-gray create-time" v-if="isArray(historyRecord) && historyRecord.length > 0">
          ...
          <view class="data-chart" v-if="pageType === 'weight' || pageType === 'bp'">
            <uniEcCharts class="uni-ec-charts" id="uni-ec-charts" :ec="weightChartOption" v-if="pageType === 'weight'">
            </uniEcCharts>
            <uniEcCharts class="uni-ec-charts" id="uni-ec-charts" :ec="BPChartOption" v-if="pageType === 'bp'">
            </uniEcCharts>
          </view>
          <view class="history-record">
            ...
            <view class="list-box cu-list" v-if="historyRecord && historyRecord.length > 0">
              <view class="cu-item list-item" :class="modalName == 'move-box-' + index ? 'move-cur' : ''"
                ...
                :data-target="'move-box-' + index" @tap="updateItem(item)" v-for="(item, index) in historyRecord"
                :key="index">
