  ...
  <view class="u-notice-bar" :style="{
    ...
    <swiper :disable-touch="disableTouch" @change="change" :autoplay="autoplay && playState == 'play'"
      ...
      <swiper-item v-for="(item, index) in list" :key="index" class="u-swiper-item">
        <view class="u-news-item u-line-1 u-flex-1" :style="[textStyle]" @tap="click(index)"
          :class="['u-type-' + type]">
          {{ item }}
        </view>
      </swiper-item>
    ...
    <view class="u-icon-wrap">
      <u-icon @click="getMore" class="u-right-icon" v-if="moreIcon" name="arrow-right" :size="26" :color="computeColor">
      </u-icon>
